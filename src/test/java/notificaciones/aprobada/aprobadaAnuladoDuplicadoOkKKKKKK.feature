Feature: Ejecutar Endpoint para crear una transaccion aprobada con firma y validando distintos datos de respuesta
  ...
  Scenario Outline: peticion Post que obtiene el token de cognito y luego lo pasa al header de la peticion de aprobacion con firma
    ...
    * eval sleep(24)
    ...
    And assert responseTime >= responseTimeRange.min && responseTime <= responseTimeRange.max
    Examples:
      | notiAprobada | tipoA | notiAnulada | tipoB | notiDuplicado | tipoC |
      #-| true         | 1     | true        | 1     | true          | 1     | # notifica3
      #-| true         | 1     | true        | 1     | false         | 1     | # notifica2
      #-| true         | 1     | false       | 1     | true          | 1     | # notifica3
...
# -----------------------------------------------------------------------------------------SMS-14-----------
      ...
      #| true         | 1     | true        | 1     | false         | 2     | # notifica2
      #| true         | 1     | false       | 1     | true          | 2     | # notifica3
...
# ------------------------------------------------------------------------------------------SMS-10--W-4-------
      ...
      #| true         | 1     | true        | 2     | false         | 1     | # notifica2
      #| true         | 1     | false       | 2     | true          | 1     | # notifica3
...
# --------------------------------------------------------------------------------------------SMS-8---W-6----
      ...
      #| true         | 1     | true        | 2     | false         | 2     | # notifica2
      #| true         | 1     | false       | 2     | true          | 2     | # notifica3
...
# -------------------------------------------------------------------------------------------SMS-4---W-10----
      ...
      #| true         | 2     | true        | 2     | false         | 2     | # notifica2
      #| true         | 2     | false       | 2     | true          | 2     | # notifica3
...
# ---------------------------------------------------------------------------------------------SMS-0---W-14---
      ...
      #| true         | 2     | true        | 2     | false         | 1     | # notifica2
      #| true         | 2     | false       | 2     | true          | 1     | # notifica3
...
# ------------------------------------------------------------------------------------------SMS-4----W-10----
      ...
      #| true         | 2     | true        | 1     | false         | 2     | # notifica2
      #| true         | 2     | false       | 1     | true          | 2     | # notifica3
...
# ------------------------------------------------------------------------------------------SMS-6---W-8-----
      ...
      #| true         | 2     | true        | 1     | false         | 1     | # notifica2
      #| true         | 2     | false       | 1     | true          | 1     | # notifica3
